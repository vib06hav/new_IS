...
# Scan Dummy App (8) for box positions and nearby labels
doc = fitz.open('Original PDF/Dummy App (8).pdf')
...
with open('Dumps/app8_mapping.txt', 'w', encoding='utf-8') as f:
    ...
    for page_layout in extract_pages('Original PDF/Dummy App (8).pdf'):
...
print("Done - check Dumps/app8_mapping.txt")
