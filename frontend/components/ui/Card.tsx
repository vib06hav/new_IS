...
export function Card({ title, description, eyebrow = "Interview Standardiser", children }: CardProps) {
  return (
    <section className="fade-rise clay-card rounded-2xl p-6 shadow-[var(--card-shadow-soft)]">
      <div className="mb-4 space-y-1">
        {eyebrow ? (
          <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-[color:var(--muted)]/80">{eyebrow}</p>
        ) : null}
