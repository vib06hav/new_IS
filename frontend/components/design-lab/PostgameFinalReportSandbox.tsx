...
export function PostgameFinalReportSandbox() {
  return (
    <div
      className={[
            ...
            <section className="overflow-hidden rounded-[2rem] border border-[#727D97] bg-[linear-gradient(135deg,#c9d0dc_0%,#d8dbe2_40%,#ced4df_100%)] p-6">
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  >
                    Postgame final report slice
                  </h1>
                  <p className="max-w-3xl text-sm leading-7 text-[#49536B]">
                    Detached mock of the real postgame review flow using one theme, accordion question cards, and a final summary card.
                  </p>
                </div>
              </div>
            </section>
            ...
            <div className="space-y-6">
              <section className="rounded-[1.6rem] border border-slate-200 bg-white/90 p-5 shadow-[0_18px_36px_rgba(15,23,42,0.1)] backdrop-blur">
                <div className="space-y-2">
                  ...
                  <h2 className="text-xl font-semibold tracking-tight text-slate-900">Technical Depth vs Practice</h2>
                </div>
              ...
              <Card title="Final summary" description="Optional top-line wrap-up for the final interview report." eyebrow={null}>
                <div className="space-y-4">
                  <TextAreaField
                    label="Final summary"
                    rows={3}
                    value="Shows strong conceptual interest and communicates technical ideas clearly. Still needs stronger evidence of hands-on building and practical execution."
                  />
                  <button
                    className="inline-flex items-center gap-1 text-xs font-semibold text-blue-700 transition hover:text-blue-800"
                    type="button"
