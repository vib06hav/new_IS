      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          <section className="rounded-[2rem] border border-slate-200 bg-slate-50 p-6 text-sm leading-7 text-slate-600">
            Password changes, MFA, email ownership, and profile image updates now happen through the provider sign-in
            flow. If your access should change, contact an admin to update your local app access.
          </section>
        </div>
      )}
    </div>
